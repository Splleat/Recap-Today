...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('id', id))..add(DiagnosticsProperty('text', text))..add(DiagnosticsProperty('subText', subText))..add(DiagnosticsProperty('dayOfWeek', dayOfWeek))..add(DiagnosticsProperty('selectedDate', selectedDate))..add(DiagnosticsProperty('isRoutine', isRoutine))..add(DiagnosticsProperty('startTime', startTime))..add(DiagnosticsProperty('endTime', endTime))..add(DiagnosticsProperty('color', color))..add(DiagnosticsProperty('hasAlarm', hasAlarm))..add(DiagnosticsProperty('alarmOffset', alarmOffset))..add(DiagnosticsProperty('userId', userId))..add(DiagnosticsProperty('isSynced', isSynced));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,text,subText,dayOfWeek,selectedDate,isRoutine,startTime,endTime,color,hasAlarm,alarmOffset,userId,isSynced);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'ScheduleItem(id: $id, text: $text, subText: $subText, dayOfWeek: $dayOfWeek, selectedDate: $selectedDate, isRoutine: $isRoutine, startTime: $startTime, endTime: $endTime, color: $color, hasAlarm: $hasAlarm, alarmOffset: $alarmOffset, userId: $userId, isSynced: $isSynced)';
}
...
@useResult
$Res call({
 String id, String text, String? subText, int? dayOfWeek, DateTime? selectedDate, bool isRoutine,@TimeOfDayConverter() TimeOfDay startTime,@TimeOfDayConverter() TimeOfDay endTime,@ColorConverter() Color? color, bool? hasAlarm, Duration? alarmOffset, String userId, bool isSynced
});
...
/// Create a copy of ScheduleItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? text = null,Object? subText = freezed,Object? dayOfWeek = freezed,Object? selectedDate = freezed,Object? isRoutine = null,Object? startTime = null,Object? endTime = null,Object? color = freezed,Object? hasAlarm = freezed,Object? alarmOffset = freezed,Object? userId = null,Object? isSynced = null,}) {
...
class _ScheduleItem with DiagnosticableTreeMixin implements ScheduleItem {
  const _ScheduleItem({required this.id, required this.text, this.subText, this.dayOfWeek, this.selectedDate, required this.isRoutine, @TimeOfDayConverter() required this.startTime, @TimeOfDayConverter() required this.endTime, @ColorConverter() this.color = Colors.lightBlueAccent, this.hasAlarm = false, this.alarmOffset = const Duration(hours: 1), required this.userId, this.isSynced = false});
...
@override@JsonKey() final  bool? hasAlarm;
@override@JsonKey() final  Duration? alarmOffset;
...
/// Create a copy of ScheduleItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? text = null,Object? subText = freezed,Object? dayOfWeek = freezed,Object? selectedDate = freezed,Object? isRoutine = null,Object? startTime = null,Object? endTime = null,Object? color = freezed,Object? hasAlarm = freezed,Object? alarmOffset = freezed,Object? userId = null,Object? isSynced = null,}) {
