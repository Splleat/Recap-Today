...
mixin _$ChecklistItem {
 ...
 String get id; String get text; String? get subtext; bool get isChecked; DateTime? get dueDate; DateTime? get completedDate; String get userId; bool get isSynced;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,text,subtext,isChecked,dueDate,completedDate,userId,isSynced);

@override
String toString() {
  return 'ChecklistItem(id: $id, text: $text, subtext: $subtext, isChecked: $isChecked, dueDate: $dueDate, completedDate: $completedDate, userId: $userId, isSynced: $isSynced)';
}
...
@useResult
$Res call({
 String id, String text, String? subtext, bool isChecked, DateTime? dueDate, DateTime? completedDate, String userId, bool isSynced
});
...
/// Create a copy of ChecklistItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? text = null,Object? subtext = freezed,Object? isChecked = null,Object? dueDate = freezed,Object? completedDate = freezed,Object? userId = null,Object? isSynced = null,}) {
...
class _ChecklistItem implements ChecklistItem {
  const _ChecklistItem({required this.id, required this.text, this.subtext, this.isChecked = false, this.dueDate, this.completedDate, required this.userId, this.isSynced = false});
...
/// Create a copy of ChecklistItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? text = null,Object? subtext = freezed,Object? isChecked = null,Object? dueDate = freezed,Object? completedDate = freezed,Object? userId = null,Object? isSynced = null,}) {
